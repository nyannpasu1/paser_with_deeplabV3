...
@hydra.main(version_base=None, config_path="conf", config_name="pretrain_seg_deeplabv3")
...
def create_model(cfg: DictConfig):
    ...
    if cfg.model.name in {'unet'}:
        ...
        model = DeepLabV3(n_channels=cfg.model.n_channels, n_classes=cfg.model.n_classes, backbone=cfg.model.backbone, pretrained=cfg.model.pretrained)
    else:
